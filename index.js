...
app.get("/legal", (request, response) => {
  response.redirect(301, 'mailto:legal@wgyt.tk?cc=wgyt@wgyt.tk&subject=Scratch%20Legal')
});
...
app.get("/scratchsound/search.xml", (request, response) => {
  response.sendFile(`${__dirname}/public/soundsearch.xml`);
});
